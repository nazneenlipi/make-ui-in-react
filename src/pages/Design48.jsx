    ...
    <div className="bg-[#fbd745] text-black flex flex-col items-center justify-center overflow-hidden relative">
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between py-12">
        ...
        <div className="flex-1 max-w-lg space-y-6 text-center md:text-left">
          ...
          >
            <span className="absolute inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-black rounded-full group-hover:-translate-x-0 group-hover:-translate-y-0"></span>
            <span className="absolute inset-0 w-full h-full bg-[#fbd745] border-2 border-black rounded-full group-hover:bg-black"></span>
            <span className="relative text-black group-hover:text-white text-4xl md:text-5xl lg:text-4xl font-bold">
              digital
            </span>
          </a>
