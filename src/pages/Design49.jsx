    ...
    <div className="relative bg-yellow-200 min-h-screen flex items-center justify-center">
      ...
      <div className="grid md:grid-cols-2 gap-4 w-full max-w-6xl mx-auto p-4">
        ...
        <div className="relative flex justify-center">
          ...
          <div className="absolute bottom-16 right-0 transform rotate-12 bg-yellow-100 p-2 rounded shadow-sm text-xs max-w-[180px]">
            <p className="text-black font-light">
              Be yourself. Let who you are, what you are, speak for itself.
            </p>
          </div>
          <div className="absolute bottom-32 left-0 transform -rotate-12 bg-yellow-100 p-2 rounded shadow-sm text-xs max-w-[180px]">
            <p className="text-black font-light">
