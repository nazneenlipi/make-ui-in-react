...
const Design42 = () => {
  ...
  return (
    <div className="relative bg-white max-w-6xl mx-auto py-12 ">
      <div className="flex flex-col lg:flex-row items-start gap-14">
        ...
        <div className="relative flex-1">
          <img
            src={star}
            alt="Star decoration"
            className="absolute -left-12 top-0 w-20 h-20"
          />

          <div className="border-2 rounded-t-full p-4 border-black  absolute right-6 w-[405px] h-full z-0"></div>

          <div className="relative z-10">
            <img
              src={imageMain}
              alt="Japanese temple with cherry blossoms"
              className="rounded-lg w-[350px] h-[450px] mx-auto my-6"
            />

            {/* Floating Comments */}
            <div className="absolute top-60 -left-16 bg-white bg-opacity-80 p-3 rounded-lg shadow-md w-52 border border-black">
              <div className="flex items-center justify-center gap-2">
                <img src={men1} alt="User" className="w-16 h-16 rounded-full" />
      ...
      {/* Stats Section */}
      <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 justify-center text-start gap-x-24">
        <div
